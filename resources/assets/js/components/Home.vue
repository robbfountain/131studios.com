<template>
    <div class="page">
        ...
        <div class="banner bg-blue-darker text-center xs:px-2 xs:py-2 lg:py-12">
            ...
            <h1 class="text-white text-5xl mt-6 mb-1 font-light">131 Studios</h1>
            <h2 class="text-white text-xg font-light">Web Development, Web Design and Consulting</h2>
        </div>
        ...
        <section class="bg-white py-12 px-2">
            <div class="container mx-auto flex justify-between xs:flex-col lg:flex-row ">
                ...
                <div class="group mr-4 flex xs:mb-4">
                    <div class="mr-3">
                        <div class="transition group-hover:bg-blue-darker group-hover:text-white rounded-full border bg-gray-@300 p-6 text-center text-2xl">
                            <fa icon="code"></fa>
                        </div>
                    </div>
                    <div class="mt-3">
                ...
                <div class="group mr-4 flex xs:mb-4">
                    <div class="mr-3">
                        <div class="rounded-full border bg-gray-@300 p-6 text-center text-2xl">
            ...
            <div class="container mx-auto">
                ...
                <div class="owl-carousel owl-theme">
                        ...
                        <div v-for="(project, index) in projects" :key="project.id"
                            ...
                            <div class="px-6 py-4">
                                <span class="inline-block bg-gray-@300 rounded-full px-3 py-1 text-sm font-semibold text-gray-600 mr-2">#photography</span>
                                <span class="inline-block bg-gray-@300 rounded-full px-3 py-1 text-sm font-semibold text-gray-600 mr-2">#travel</span>
                                <span class="inline-block bg-gray-@300 rounded-full px-3 py-1 text-sm font-semibold text-gray-600">#winter</span>
