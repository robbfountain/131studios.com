    ...
    <div class="dropdown relative inline-block text-left">
        <div>
            <span class="rounded-md shadow-sm">
                <button @click="isOpen = !isOpen" type="button" class="inline-flex justify-center w-full px-4 py-2 bg-white text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">
