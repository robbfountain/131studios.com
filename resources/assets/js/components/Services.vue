            ...
            <div class="container mx-auto">
                <div class="flex xs:flex-col md:flex-row">
                    ...
                    <div class="lg:w-1/3 rounded overflow-hidden shadow-lg lg:mr-8 mb-4">
                        ...
                        <div class="p-4">
                            <h2 class="text-2xl text-gray-600">Web Development</h2>
                            <p class="text-gray-600 leading-normal mt-4">
                    ...
                    <div class="lg:w-1/3 rounded overflow-hidden shadow-lg lg:mr-8 mb-4">
                        ...
                        <div class="p-4">
                            <h2 class="text-2xl text-gray-600">Hosting & Maintenance</h2>
                            <p class="text-gray-600 leading-normal mt-4">
                    ...
                    <div class="lg:w-1/3 rounded overflow-hidden shadow-lg lg:mr-8 mb-4">
                        ...
                        <div class="p-4">
                            <h2 class="text-2xl text-gray-600">IT Services</h2>
                            <p class="text-gray-600 leading-normal mt-4">
