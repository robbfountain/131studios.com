<template>
	<div class="col-md-6" >
       <section id="contact">
		...
		<div class="alert alert-info" v-show="! hasError">Please consider using our <a href="/contact/project">expanded contact form</a> to provide additional details about your project needs. </div>
