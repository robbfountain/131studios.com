        ...
        <div class="row margin-top-80">
            ...
            <div class="col-md-3 col-sm-12">
                <div class="icon-box-3 rounded light">
                    ...
                    <p>Custom backend development, Content Management Systems and SaaS applications are just some of the
                        development works we have done.</p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="icon-box-3  rounded light">
                    ...
                    <h4>IT Services</h4>
                    <p>Small and Home Office IT Solutions for your business. Server &amp; worstation management,
                        patching, security and software management are just some of the consulting services we
                        offer.</p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="icon-box-3 rounded light">
                    ...
                    <p>We offer powerful VPS hosting systems for your website and we take care of everything from server
                        maintenance to application deployment.</p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="icon-box-3 rounded light">
                    ...
                    <h4>Web Design</h4>
                    <p>We can give your website a new look with modern touches. We partner with top notch graphics
