                        ...
                        <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6"
                            ...
                            <div class="flex items-center flex-1">
                                <div class="flex items-center justify-between w-full md:w-auto">
                                    <a href="{{route('index')}}">
                                        <span class="sr-only">{{$title ?? config('app.name')}}</span>
                                        <img class="h-8 w-auto sm:h-10"
                                             src="{{asset('images/logo-image-55x55.png')}}"
                                ...
                                <div class="hidden space-x-8 md:flex md:ml-10">
                                    ...
                                    <a href="#" class="text-base font-medium text-white hover:text-gray-300">Portfolio</a>
                            ...
                            <div class="hidden md:flex md:items-center md:space-x-6">
                                ...
                                <a href="#"
                                   class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-blue-800 hover:bg-blue-900">
                                    Client Login
                                </a>
                            </div>
                        </nav>
                        ...
                        <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                            ...
                            <div class="pt-5 pb-6">
                                <div class="px-2 space-y-1">
                                    ...
                                    <a href="#"
                                       class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">Case Studies</a>
                                ...
                                <div class="mt-6 px-5">
                                    <p class="text-center text-base font-medium text-gray-500">Existing client? <a
