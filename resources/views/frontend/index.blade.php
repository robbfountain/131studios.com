                                                ...
                                                <div class="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                                    ...
                                                    <a href="#"
                                                       class="-m-3 p-3 block space-y-1 rounded-md hover:bg-gray-50 transition ease-in-out duration-150">
                                                        ...
                                                        <p class="text-sm leading-5 text-gray-500">
                                                            Get all of your questions answered in our forums of contact
                                                            support.
                                                        </p>
                                                    </a>
                                                    <a href="#"
            ...
            <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="lg:text-center">
                    ...
                    <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
                        The Local Leader in Website Services
                    </h3>
                    <p class="mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto">
                        We get it...It can be difficult to establish your online presence. From designing your website
                        or updating an existing site, there's a lot to handle. We want to make this process easy for
                        you.
                    </p>
                </div>
                    ...
                    <ul class="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                                        Stand out from your competitors with a professionally designed website from 131
                                        Studios.
                                    </p>
                                </div>
                            </div>
                        ...
                        <li class="mt-10 md:mt-0">
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                                        Host your website on industry leading Private Servers that are 100% maintained
                                        by us.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    <h5 class="text-lg leading-6 font-medium text-gray-900">
                                        Social Media</h5>
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                                        Get your business noticed on social networks by letting us manage you social
                                        media accounts.
                                    </p>
                                </div>
                            </div>
                        ...
                        <li class="mt-10 md:mt-0">
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    <h5 class="text-lg leading-6 font-medium text-gray-900">Search Engine Optimization
                                        (SEO)
                                    </h5>
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                                        We'll make sure your customers can find you on the web by optimizing your
