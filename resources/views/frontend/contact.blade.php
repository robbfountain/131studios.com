...
<div class="container" id="app" >
     <div class="row" >
		...
		<p>If you would like to give us a little more information regarding your needs please use our expanded contact form <a href="{{route('contact.project')}}">here.</a></p>
        </div> <!-- col-md-6 -->
     </div> <!-- row -->
</div> <!-- container -->
@stop