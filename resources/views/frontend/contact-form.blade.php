<contact inline-template>
    <div>
        ...
        <form @submit.prevent>
            <label for="name" class="block text-grey-dark text-sm font-bold mb-1">Your Name</label>
            <input name="name" type="text" id="name"
                   class="border rounded w-full py-3 px-4 text-grey-dark leading-tight"
            ...
            <label for="email" class="block text-grey-dark text-sm font-bold mb-1 mt-4">Your Email</label>
            ...
            <label for="message" class="block text-grey-dark text-sm font-bold mb-1 mt-4">Message</label>
